...
## RF 
The board operates on the 920 MHz band. The output power is aproximatly 33dBm (to be tested). The device requires a ISED HAM licence (or equivilant) to operate in Canada.

## Register Configurations
Registers can be configured using the SMARTRFTM-STUDIO [Windows only] application (https://www.ti.com/tool/SMARTRFTM-STUDIO).
