# 1 "canlib/message/msg_actuator.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "canlib/message/msg_actuator.c" 2
...
# 2 "canlib/message/msg_actuator.c" 2
...
# 4 "canlib/message/msg_actuator.c" 2
...
# 5 "canlib/message/msg_actuator.c" 2
...
# 7 "canlib/message/msg_actuator.c" 2
...
_Bool build_actuator_cmd_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_ACTUATOR_CMD << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
...
_Bool build_actuator_analog_cmd_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_ACTUATOR_ANALOG_CMD << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
...
_Bool build_actuator_status_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_ACTUATOR_STATUS << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
