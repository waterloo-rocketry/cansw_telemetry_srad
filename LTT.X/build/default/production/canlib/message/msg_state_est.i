# 1 "canlib/message/msg_state_est.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "canlib/message/msg_state_est.c" 2
...
# 2 "canlib/message/msg_state_est.c" 2
...
# 3 "canlib/message/msg_state_est.c" 2
...
# 5 "canlib/message/msg_state_est.c" 2
...
# 6 "canlib/message/msg_state_est.c" 2
...
# 7 "canlib/message/msg_state_est.c" 2
...
# 8 "canlib/message/msg_state_est.c" 2
...
_Bool build_state_est_data_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_STATE_EST_DATA << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
