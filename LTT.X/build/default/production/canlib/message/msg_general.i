# 1 "canlib/message/msg_general.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "canlib/message/msg_general.c" 2
...
# 2 "canlib/message/msg_general.c" 2
...
# 3 "canlib/message/msg_general.c" 2
...
# 5 "canlib/message/msg_general.c" 2
...
# 6 "canlib/message/msg_general.c" 2
...
# 7 "canlib/message/msg_general.c" 2
...
# 8 "canlib/message/msg_general.c" 2
...
_Bool build_general_board_status_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_GENERAL_BOARD_STATUS << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
...
_Bool build_reset_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_RESET_CMD << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
...
_Bool build_debug_raw_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_DEBUG_RAW << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
...
_Bool build_config_set_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_CONFIG_SET << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
...
_Bool build_config_status_msg(
    ...
    output->sid = (((uint32_t)prio << 27) | ((uint32_t)MSG_CONFIG_STATUS << 18) | ((uint32_t)BOARD_TYPE_ID_TELEMETRY << 8) | BOARD_INST_ID_GENERIC);
    write_timestamp_2bytes(timestamp, output);
